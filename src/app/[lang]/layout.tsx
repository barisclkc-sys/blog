...
export default async function RootLayout(props: {
  ...
  return (
    ...
    >
      <body className="min-h-screen bg-[#0a0a0a] text-neutral-300 font-sans selection:bg-neutral-800 selection:text-neutral-100">
        
        {/* Fixed Top Left Language Switcher */}
        ...
        <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-20 md:px-12 md:py-24 lg:px-24 lg:py-0">
          <div className="lg:flex lg:justify-between lg:gap-16">
            ...
            <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-5/12 lg:flex-col lg:justify-between lg:py-24 pt-12">
              <div>
                <h1 className="text-4xl font-bold tracking-tight text-neutral-100 sm:text-5xl mt-8 lg:mt-0">
                  <Link href={`/${params.lang}`}>Barış Çolakça</Link>
                </h1>
                <h2 className="mt-4 text-lg font-medium tracking-tight text-neutral-400 sm:text-xl">
                  Engineer & Developer
                </h2>
                      ...
                      <li key={item.label}>
                        {item.external ? (
                          <a className="group flex items-center py-2" href={item.href} target="_blank" rel="noopener noreferrer">
                            <span className="mr-4 h-px w-8 bg-neutral-700 transition-all group-hover:w-16 group-hover:bg-neutral-300"></span>
                            <span className="text-xs font-semibold uppercase tracking-widest text-neutral-500 group-hover:text-neutral-200 transition-colors">
                              {item.label} ↗
                            </span>
                          </a>
                        ) : (
              ...
              <div className="mt-12 flex items-center gap-5 lg:mt-0">
                <a href="https://github.com/barisclkc-sys" target="_blank" className="text-neutral-500 hover:text-neutral-200 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
                </a>
                <a href="https://linkedin.com/in/bariscolakca" target="_blank" className="text-neutral-500 hover:text-neutral-200 transition-colors">
